...
const navigation = [
  ...
  { name: "Credit Transactions", href: "/credit-transactions", icon: FolderAddIcon },
  { name: "Debit Transactions", href: "/debit-transactions", icon: FolderRemoveIcon },
];
    ...
    <div className="flex h-screen overflow-hidden bg-gray-100">
      <Transition.Root show={sidebarOpen} as={Fragment}>
        ...
        >
          ...
          >
            <div className="relative flex flex-col flex-1 w-full max-w-xs bg-green-700">
              <Transition.Child
                as={Fragment}
              ...
              <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                <div className="flex items-center flex-shrink-0 px-4">
                  <img
                    ...
                    src="https://tailwindui.com/img/logos/workflow-logo-green-500-mark-white-text.svg"
                    alt="Workflow"
                  />
                </div>
        ...
        <div className="">
          <div className="">
            ...
            <div className="mt-4 text-center ">
              ...
              <div className="flex flex-shrink-0 p-4 bg-green-700">
      ...
      <div className="hidden md:flex md:flex-shrink-0">
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-1 h-0 bg-green-700">
                  ...
                  >
                    <item.icon
                      className={classNames(
                        item.name === page
                          ? "text-green-900"
                          : "text-gray-400 group-hover:bg-white group-hover:text-green-900",
                        "mr-3 h-6 w-6"
                      )}
                      aria-hidden="true"
                    />
